...
resource "aws_vpn_gateway" "aws-dev-vpgw-mgmt-01" {
  vpc_id            = "vpc-0317680e9bab9e292"
  tags = {
    Name = "aws-dev-vpgw-mgmt-01"
  }
}

#customer gateway
resource "aws_customer_gateway" "aws-dev-cgw-mgmt-01" {
  type        = "ipsec.1"
  bgp_asn     = 65000
  ip_address  = "xxx.xx.xxx.xx" #On Premise public IP.
  tags = {
    Name = "aws-dev-cgw-mgmt-01"
  }
}

#vpn_connection
resource "aws_vpn_connection" "aws-dev-vpn-connection-mgmt-01" {
...
#  tunnel2_phase2_lifetime_seconds         = "3600"
  ...
  tags = {
    Name = "aws-dev-vpn-connection-mgmt-01"
  }
}
#
